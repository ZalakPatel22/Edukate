...
<body>
      ...
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-lg-5 col-md-8 home-banner-left">
          ...
          <p class="mx-auto text-white  mt-20 mb-40">
            Edukate is a comprehensive IT Institute Management System designed to streamline administrative and academic operations.  
          </p>
        </div>
        ...
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            ...
            <div class="ml-20">
              <h4>New Classes</h4>
              <p>
                Edukate provides a dedicated module for class management, enabling seamless organization of academic sessions. 
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            ...
            <div class="ml-20">
              <h4>Top Courses</h4>
              <p>
                Edukate offers a diverse range of high-quality courses designed to equip students with essential IT skills. 
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex border-right-0">
            ...
            <div class="ml-20">
              <h4>Full E-Books</h4>
              <p>
                Edukate provides an extensive collection of e-books to support students in their learning journey. 
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-5">
          <div class="section-title text-white">
            <h2 class="text-white">
              ...
              <br> Edukate Live Classes!
            </h2>
            <p>
              At Edukate, we bring learning to life with live, interactive classes led by industry experts. Whether you’re a beginner or an advanced learner, our real-time sessions help you stay engaged, ask questions, and get instant feedback.
            </p>
          </div>
        </div>
          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="img/cloud-comp.jpg" alt="" style="height: 405px; max-width: 100%;">
              ...
              <h4 class="text-white mb-20 mt-30">Scale effortlessly with cloud solutions that redefine flexibility and performance</h4>
              <p class="text-white mb-20">
                Harness the power of the cloud to innovate, scale, and optimize performance with seamless connectivity and security.
              </p>
            </div>

            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="img/web-devlop.jpg" alt="" >
                <div class="overlay"></div>
                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=VufDd-QL1c0">
                  <img class="play-icon" src="img/play-btn.png" alt="">
                </a>
              </div>
              <h4 class="text-white mb-20 mt-30">Build dynamic, responsive, and high-performing websites with modern web technologies</h4>
              <p class="text-white mb-20">
                Transform ideas into immersive digital experiences with cutting-edge web technologies and interactive design.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="feature-inner row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Enjoy unlimited access to all enrolled courses, allowing you to learn at your own pace anytime, anywhere.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt--160">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Download complete project files, templates, and resources to accelerate your learning and hands-on practice.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt--260">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Gain exclusive access to a vast library of premium courses tailored to enhance your skills and career prospects.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Explore a massive collection of diverse courses across various fields, from tech to business and beyond!
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt--160">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Learn from industry professionals with real-world experience, providing insights and guidance throughout your journey.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt--260">
          <div class="other-feature-item">
            ...
            <div>
              <p>
                Get instant help and clarification from our dedicated support team, ensuring a smooth learning experience.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="item">
              <div class="testi-item">
                ...
                <div class="mt-40 text">
                  <p>
                    Education is not just about gaining knowledge—it’s about growing, evolving, and preparing for the future. Completing a course with Edukate has been an incredible experience that has truly shaped my learning journey. From expert mentorship to real-world projects, here’s how Edukate helped me achieve my goals.
                  </p>
                </div>
                <h4>Sumit Shah</h4>
                <p>Jr.Web developer  , Crical Info Tech</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5">
            <div class="item">
              <div class="testi-item">
                ...
                <div class="mt-40 text">
                  <p>
                    Education is a powerful tool, and finding the right learning platform makes all the difference. As someone who always wanted to dive into the world of technology and upskill, Edukate became the perfect place for me to learn, grow, and achieve my dreams.
                  </p>
                </div>
                <h4>Vruti Patel</h4>
                <p>Sr Cyber Security , GatiSoftTech</p>
              </div>
            </div>
          </div>
  ...
  <section class="popular-course-area section-gap">
    <div class="container-fluid">
        <div class="row justify-content-center section-title">
            <div class="col-lg-12 text-center">
                <h2>Select Courses <br /> Right Now</h2>
                <p>Explore the most in-demand courses and enhance your skills with Edukate.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="f-img img-fluid" src="img/web-devlop.jpg" alt="Web Development">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="f-img img-fluid" src="img/app-devlop.jpg" alt="App Development">
                    </div>
                    <div class="details text-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-popular-course">
                    <div class="thumb">
                        <img class="f-img img-fluid" src="img/cloud-comp.jpg" alt="Cloud Computing">
                    </div>
                    <div class="details text-center">
                        <p class="name">Cloud Computing</p>
                        <h4>Scale effortlessly with cloud solutions that redefine flexibility and performance.</h4>
